    ...
    <nav className="navbar">
      <div className="navbar__item1 container__sp ">
       ...
       <DownArrow/>
              ...
              <Link className='navbar__daxil mx-5' href="/daxilol" variant="body2">
              Daxil Ol
</Link>
               <Link  href="/qeydiyyat">

              <button type="button " class="btn btn-outline-primary navbar__button text-dark">Qeydiyyat</button>
              </Link>
...
<nav className="navbarTwo ">
       ...
       <TehsilLogo/>
          <div  tabIndex='-1' onFocus={(e)=>{
            e.currentTarget.querySelector('.buttonAlti').classList.remove('d-none')
            }} onBlur ={(e)=>{
              e.currentTarget.querySelector('.buttonAlti').classList.add('d-none')
            }} className="navbarTwo__buttonWrapper ">
              <a href="#" className="navbarTwo__button">Xəbərlər</a>
              <div className="navbarTwo__altxet d-none">

              </div>
              <div className="buttonAlti d-none">
              <a href="#" className="navbarTwo__button ms-0 mb-2">Gündəm</a>
              <a href="#" className="navbarTwo__button ms-0 mb-2">Elm və Təhsil</a>
              <a href="#" className="navbarTwo__button ms-0 mb-2">Mədəniyyət</a>
              <a href="#" className="navbarTwo__button ms-0 mb-2">Maraqlı</a>

              </div>
            </div>
            <div className="navbarTwo__buttonWrapper ">
              <a href="#" className="navbarTwo__button">Tədbirlər</a>
              <div className="navbarTwo__altxet d-none">

              </div>
            </div>
            <div className="navbarTwo__buttonWrapper ">
              <a href="#" className="navbarTwo__button">Elanlar</a>
              <div className="navbarTwo__altxet d-none">

              </div>
            </div>
            <div className="navbarTwo__buttonWrapper ">
              <a href="#" className="navbarTwo__button">Təhsil</a>
              <div className="navbarTwo__altxet d-none">

              </div>
            </div>
            <div className="navbarTwo__buttonWrapper ">
              <a href="#" className="navbarTwo__button">Digər</a>
              <div className="navbarTwo__altxet d-none">
          ...
          <div className="searcInput">
            <input placeholder='Axtar' type="text" className="seachInput__input" />
    <Search/>
      ...
      <nav className="navbarResponsive mb-4 container__sp">
        <div className="navbarResponsive__main">
          ...
          <div onClick={(e) => {
            ...
            setTimeout(()=>{ sidebar.classList.remove('right100')},500)
